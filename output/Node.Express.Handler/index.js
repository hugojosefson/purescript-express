...
var nextThrow = function (err) {
    return new HandlerM(function (v) {
        return function (v1) {
            return function (nxt) {
                return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function_Uncurried.runFn2(Node_Express_Internal_Utils.nextWithError)(nxt)(err));
            };
        };
    });
};

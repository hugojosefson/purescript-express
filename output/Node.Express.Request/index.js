    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._hasType)(req)(type_))))(function (v2) {
    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._getSignedCookie)(req)(name)));
            };
        };
    });
};
        ...
        return new Node_Express_Handler.HandlerM(function (req) {
            return function (v) {
                return function (v1) {
                    ...
                    })(Data_Function_Uncurried.runFn2($foreign._getRouteParam)(req)(name)));
                };
            };
        });
    };
    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._getHeader)(req)(field)));
            };
        };
    });
};
    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._getCookie)(req)(name)));
            };
        };
    });
};
        ...
        return new Node_Express_Handler.HandlerM(function (req) {
            return function (v) {
                return function (v1) {
                    ...
                    })(Data_Function_Uncurried.runFn2($foreign._getBodyParam)(req)(name)));
                };
            };
        });
    };
    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._acceptsLanguage)(req)(language)));
            };
        };
    });
};
    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._acceptsCharset)(req)(charset)));
            };
        };
    });
};
    ...
    return new Node_Express_Handler.HandlerM(function (req) {
        return function (v) {
            return function (v1) {
                ...
                })(Data_Function_Uncurried.runFn2($foreign._accepts)(req)(types)));
            };
        };
    });
};
